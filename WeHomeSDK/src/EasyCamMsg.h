...
enum EC_CMD_ID
{
    ...
    EC_STATION_ID_GET_RECORD_BITMAP_BY_MON = 0x1020, // 根据月份获取哪些天有录像
    EC_STATION_ID_GET_RECORD_LIST, // 获取某一天的录像列表
    EC_STATION_CMD_ID_START_PLAY_EVENT_RECORD, //根据时间和消息ID回放事件录像
    EC_STATION_CMD_ID_START_PLAY_RECORD,
    EC_STATION_CMD_ID_STOP_PLAY_RECORD,
    EC_STATION_CMD_ID_CMD_PLAY_RECORD,
